...
--  See `:help 'clipboard'`
-- On Cloudtop / remote SSH / tmux, configure OSC 52 so yank copies to local system clipboard
if vim.env.SSH_CONNECTION or vim.env.SSH_TTY or vim.env.SSH_CLIENT or vim.env.TMUX then
  vim.g.clipboard = {
    name = 'OSC 52',
    copy = {
